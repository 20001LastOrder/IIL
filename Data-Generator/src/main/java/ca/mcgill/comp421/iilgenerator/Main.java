...
public class Main {
	...
	public static void generation() {
		...
		institutionGenerator.generate(30);
		...
		librarianGenerator.generate(100);
		...
		administratorGenerator.generate(40);
		...
		bookCopyGenerator.generate(400);
